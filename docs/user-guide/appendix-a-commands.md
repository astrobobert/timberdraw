...
| `TJointAll` | Batch-cut joinery for a SELECTION (the selected timbers get joints): girt-post, post-sill, summer-girt, joist-carrier, common (ridge + eave), and purlin-rafter passes. Ch. 10 |

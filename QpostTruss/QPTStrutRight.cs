	...
	public class QPTStrutRight
	{
		...
		public void Draw()
		{
			...
			if (Module1.HasJoinery) {
				...
				TenonUpId = Module1.DrawElement(pts, TenonWidth, "Tenon", "RStrut", "UP");
                Module1.AddJoint(TimberId, TenonUpId, Module1.Joint.Tenon);
				pts.Clear();
				pts.Add(new Point3d(Module1.Span - (Module1.Span / 3.0), Module1.EaveHt + 6, tenonZ));
				...
				TenonDownId = Module1.DrawElement(pts, TenonWidth, "Tenon", "RStrut", "DN");
        ...
        private string BuildContextJson()
        {
            ...
            return string.Format(c,
                "{{\"class\":\"QPTStrutRight\",\"startX\":{0},\"startY\":{1},\"rafterWidth\":{0},\"rafterDepth\":{1},\"span\":{2},\"eaveHt\":{3},\"pitch\":{4},\"beta\":{5},\"make3D\":{6},\"offsetType\":{7}}}",
